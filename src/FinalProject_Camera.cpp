            ...
            for (auto it1 = (dataBuffer.end() - 1)->bbMatches.begin(); it1 != (dataBuffer.end() - 1)->bbMatches.end(); ++it1)
            {
                ...
                if (currBB->lidarPoints.size() > 0 && prevBB->lidarPoints.size() > 0) // only compute TTC if we have Lidar points
                {
                    ...
                    if (perf) {
                        ...
                        cout << endl;*/
                        fstream ofs;
                        string str1 = detectorType + "_" + descriptorType + ".txt";
                        ofs.open(str1, std::ios::app);
                        ofs << ttcLidar << "," << ttcCamera << "," << ttcCamera - ttcLidar << '\n';
                        ofs.close();
                    }
                    //// EOF STUDENT ASSIGNMENT
                    ...
                    if (bVis)
                    {
                        ...
                        showLidarTopview(currBB, cv::Size(4.0, 20.0), cv::Size(2000, 2000), true);
